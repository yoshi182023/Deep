...
MCP_SERVER_CONFIG = {
    "task-manager": {
        ...
        "args": ["mcp_server/task_mcp_server_solution.py"],
    }
}
...
@pytest.mark.xfail(reason="gemma4:e4b-it-q4_k_M does not reliably chain task ID lookup with update")
...
@pytest.mark.xfail(reason="gemma4:e4b-it-q4_k_M too small for ambiguous request handling")
...
class MCPToolCorrectnessMetric(ToolCorrectnessMetric):
    ...
    def __init__(self, expected_tool: str, threshold: float = 1.0, **kwargs):
